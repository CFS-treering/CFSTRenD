...
# read ring measurement
 ...
 #
#  f <- system.file("extdata", "IDF.trt.rdata", package = "CFSTRenD")
# load(f)
...
p.ispc<- CFSTRenD:::plot_ds(list(tr_6i, tr_7i))
...
plot_list.rw <- CFSTRenD:::plot_facet(data = tr_7i, varcols = c("year", "rw_mm", "site_id"), xylabels = c("Year", "Ring Width (mm)"), nrow = 2, ncol = 2)
# plot_list.rw[[4]] <- NULL
library(patchwork)
