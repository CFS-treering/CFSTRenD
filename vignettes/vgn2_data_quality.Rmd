...
# 
# # formatting the users' data conformed to CFS-TRenD structure
...
samples69.trt <- readRDS(system.file("extdata", "samples69.trt.rds", package = "growthTrendR"))
...
dt.scale <- CFS_scale( target_site = target_site, ref_sites = ref.sites, scale.label_data_ref = "CFS-TRenD V1.2-proj69", scale.max_dist_km = 20, scale.N_nbs = 5)
```
...
# otherwise, run function CFS_format() from raw dataset
# # ring measurement
# samples69.o <- fread(system.file("extdata", "samples69.csv", package = "growthTrendR"))
# 
# # formatting the users' data conformed to CFS-TRenD structure
...
dt.qa <-CFS_qa(dt.input = samples69_long, qa.label_data = "CFS-TRenD V1.2-proj69", qa.label_trt = "difference", qa.min_nseries = 50)
```
